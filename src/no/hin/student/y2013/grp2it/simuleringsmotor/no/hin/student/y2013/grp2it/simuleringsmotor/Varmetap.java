...
public class Varmetap extends BygningBase {
	...
	public boolean doBeregning(long startTime, long lengde)
	{
		...
		this.varmetap = (yttertakAreal*utak)+(ytterveggAreal*uvegg)+(bruttoAreal*ugulv)+(vinduDørAreal*uvinduDør)+(kuldebro*bruttoAreal)+(0.33*lekkasjetall*luftVolum*0.07)+(0.33*(luftVolum*0.5)*(1-gjenvinningsgrad));
