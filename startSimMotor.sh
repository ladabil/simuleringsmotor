...
/usr/bin/jsvc -jvm server -pidfile ~/simuleringsMotor_SimuleringsMotor.pid -outfile ~/out_SimuleringsMotor.log -errfile ~/err_SimuleringsMotor_err.log -cp ${MYCLASSPATH} no.hin.student.y2013.grp2it.simuleringsmotor.SimuleringsMotor
